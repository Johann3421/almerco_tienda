...
<table style="width: 100%; background-color: #f6711f; color: white; padding: 20px; border-radius: 10px;">
    <tr>
        <td style="text-align: center;">
          ...
          <br><br>
          <img src="https://kambista.com/wp-content/uploads/2020/01/Interbank.png" alt="Interbank" style="width: 150px;">
        </td>
            ...
            <td style="text-align: right; vertical-align: top;">
                ...
                <div>
                    <a href="https://www.facebook.com/GrupoalmercoPeru/" style="text-decoration: none; margin-right: .3rem;">
                      <img src="https://logodownload.org/wp-content/uploads/2014/09/facebook-logo-1-2.png" alt="Facebook" style="width: 20px; height: 20px;">
                    </a>
                    <a href="https://api.whatsapp.com/send/?phone=51991375813&text=%C2%A1Hola%21+Quiero+recibir+mas+informaci%C3%B3n+y+promociones.&type=phone_number&app_absent=0" style="text-decoration: none; margin: 0 .3rem;">
                      <img src="https://static.vecteezy.com/system/resources/previews/017/743/717/original/instagram-icon-logo-free-png.png" alt="Instagram" style="width: 20px; height: 20px;">
                    </a>
                    <a href="https://www.tiktok.com/@grupo_almerco" style="text-decoration: none; margin-left: .3rem;">
                      <img src="https://static.vecteezy.com/system/resources/previews/016/716/450/original/tiktok-icon-free-png.png" alt="TikTok" style="width: 20px; height: 20px;">
                    </a>
                </div>
            </td>
        </tr>
